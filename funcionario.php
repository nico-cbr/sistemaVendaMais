          ...
          <div class="col-md card p-3">
            ...
            <form action="<?=$destino?>" method="post">
              ...
              <div class="form-group mt-1">
                <label>Celular</label>
                <input name="celular" value="<?php echo isset($dadosAlt) ? $dadosAlt['celular'] : '' ?>" type="text" class="form-control celular" placeholder="Digite o numero de celular." required>
              </div>
